...
url = 'https://camping.gtdc.or.kr/DZ_reservation/reserCamping_v3.php?xch=reservation&xid=camping_reservation&step=Areas&sdate=202202' # 목적 홈페이지 주소
    ...
    while True:
        ...
        if(current_time[3] == '10' and current_time[4] == '00' and current_time[5] == '00'):
            ...
            if(int(msec[0]) >= 0):
                ...
                # 날짜 지정
                xpath = "//button[@value='A:2022-02-19']"
                driver.find_element(By.XPATH, xpath).click()

                time.sleep(0.1)
                # 구역 지정
                xpath = "//html/body/div[4]/table/tbody/tr/td[3]/div/div/div[4]/div/button[42]" 
